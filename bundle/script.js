...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./src/styles.css
var styles = __webpack_require__(804);
...
// EXTERNAL MODULE: ./src/templates/menu-template.handlebars
var menu_template_handlebars = __webpack_require__(251);
var menu_template_handlebars_default = /*#__PURE__*/__webpack_require__.n(menu_template_handlebars);
;// CONCATENATED MODULE: ./src/images/sprite.svg
/* harmony default export */ const sprite = (__webpack_require__.p + "images/sprite.svg");
;// CONCATENATED MODULE: ./src/js/listeners.js

switcherF();
js_refs.switcher.addEventListener('click', function (event) {
  js_refs.body.classList.toggle('dark-theme');
  localStorage.setItem('theme', js_refs.body.classList);
...
function switcherF() {
  ...
  if (theme) {
    js_refs.body.classList.add(theme);
    js_refs.switcher.checked = checked;
  }
}
...
var markup = menu_template_handlebars_default()(menu_namespaceObject);
js_refs.menu.innerHTML = markup;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"menu__item\">\n  <article class=\"card\">\n    <img\n      src=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"image") || (depth0 != null ? lookupProperty(depth0,"image") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data,"loc":{"start":{"line":5,"column":11},"end":{"line":5,"column":20}}}) : helper)))
    + "\"\n      alt="
    + alias4(((helper = (helper = lookupProperty(helpers,"desription") || (depth0 != null ? lookupProperty(depth0,"desription") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"desription","hash":{},"data":data,"loc":{"start":{"line":6,"column":10},"end":{"line":6,"column":24}}}) : helper)))
    ...
    + "</p>\n\n      <ul class=\"tag-list\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"ingredients") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":19,"column":10},"end":{"line":21,"column":17}}})) != null ? stack1 : "")
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":4},"end":{"line":30,"column":11}}})) != null ? stack1 : "");
},"useData":true});
